...
{
    CGRect bounds = [title boundingRectWithSize:CGSizeMake(1000, 28) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObject:MEDIUMFONT(13.f) forKey:NSFontAttributeName] context:nil];
    ...
    self.titleLabel.font = LIGHTFONT(14.f);
