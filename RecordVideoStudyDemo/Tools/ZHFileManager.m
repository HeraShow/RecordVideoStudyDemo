...
+ (NSString *)homeMainDictionary{
    return NSHomeDirectory();
}

+ (NSString *)doumentFileDictionary {
    return [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) firstObject];
}

+ (NSString *)libraryFileDictionary {
    return [NSSearchPathForDirectoriesInDomains(NSLibraryDirectory, NSUserDomainMask, YES) lastObject];;
}

+ (NSString *)perferenceFileDictionary {
    NSString *libraryDir = [self libraryFileDictionary];
    return [libraryDir stringByAppendingPathComponent:@"Preferences"];
}

+ (NSString *)cachesFileDictionary {
    return [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) firstObject];
}

+ (NSString *)tempFileDictionary {
...
+ (NSArray *)listFilesInHomeDirectoryByDeep:(BOOL)deep {
    return [self listFilesInDirectoryAtPath:[self homeMainDictionary] deep:deep];
}

+ (NSArray *)listFilesInLibraryDirectoryByDeep:(BOOL)deep {
    return [self listFilesInDirectoryAtPath:[self libraryFileDictionary] deep:deep];
}

+ (NSArray *)listFilesInDocumentDirectoryByDeep:(BOOL)deep {
    return [self listFilesInDirectoryAtPath:[self doumentFileDictionary] deep:deep];
}

+ (NSArray *)listFilesInTmpDirectoryByDeep:(BOOL)deep {
    return [self listFilesInDirectoryAtPath:[self tempFileDictionary] deep:deep];
}

+ (NSArray *)listFilesInCachesDirectoryByDeep:(BOOL)deep {
    return [self listFilesInDirectoryAtPath:[self cachesFileDictionary] deep:deep];
}
...
+ (BOOL)clearCachesDirectory {
    ...
    for (NSString *file in subFiles) {
        NSString *absolutePath = [[self cachesFileDictionary] stringByAppendingPathComponent:file];
...
+ (BOOL)clearTmpDirectory {
    ...
    for (NSString *file in subFiles) {
        NSString *absolutePath = [[self tempFileDictionary] stringByAppendingPathComponent:file];
        isSuccess &= [self removeItemAtPath:absolutePath];
    }
    return isSuccess;
}
