...
/**
 获取沙盒主目录文件下的 Library 文件夹路径

 @return Library 文件夹路径
 */
+ (NSString *)libraryFileDictionary;

/**
 获取沙盒主目录文件下的 Temp 文件夹路径
...
/**
 获取 Library 文件下的 Perference 文件夹路径

 @return Perference 文件夹路径
 */
+ (NSString *)perferenceFileDictionary;

# pragma mark - 遍历沙盒目录路径下的文件夹
/**
 文件遍历
